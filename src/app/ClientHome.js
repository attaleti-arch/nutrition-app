...
מה קיבלת כאן?
ליווי מותאם אישית מאתי רפאלה זיתון, יועצת בריאות במגמת תזונה התנהגותית — שמביאה כלים, ידע ותמיכה לדרך. הכל בנוי סביב השינוי שרלוונטי לך, לא על פרוטוקול אחיד.
...
export default function ClientHome() {
  ...
  return (
    <div style={{minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',background:'linear-gradient(160deg,#f0fdf4,#eff6ff)',padding:24,direction:'rtl'}}>
      ...
      <div style={{fontSize:14,color:'#6b7280',marginBottom:30}}>אתי רפאלה זיתון - תוכנית תזונה אישית</div>
