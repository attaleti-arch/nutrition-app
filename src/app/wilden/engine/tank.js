...
// לא כולא. אז אין כלוב: גוסטבו שנשאב נשאר בתוך הכלי שקנו, במיכל הזכוכית
...
export const TAMED_NAME = 'גוסטבו טוב לב'
export { HATCH_M }

// ── מה יש במיכל ──
// inTank הוא כמה גוסטבו נשאבו ועוד לא רוככו. הוא יכול לעבור חמישה
