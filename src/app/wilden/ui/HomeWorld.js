...
// השומר עומד לפני הכד, על אבני הריצפה. במקום הקודם הרגליים נחתו בדיוק על
// השפה הרחוקה של הכד, והוא נראה מרחף מעליו. אותה נקודה בדיוק כמו בפתיחה,
// כדי שהוא לא יקפוץ בין הסיפור לבית.
...
export const GUARDIAN = { x: 30, y: 58, h: 21.6 }
