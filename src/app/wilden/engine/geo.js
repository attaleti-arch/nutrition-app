...
// ── גרירת מפה מסובבת ──
// "תזוזה ימינה מזיזה מפה שמאלה ולמעלה הופך למטה." המפה מוצגת מסובבת
// ב-(-rot) מעלות כדי שהמסלול יצביע לכיוון ההליכה, אבל מנוע המפה מקבל את
// תנועת האצבע במערכת הצירים שלו ולא יודע על הסיבוב.
//
