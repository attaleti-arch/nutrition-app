...
const PLAN = {
  ...
  protOptions: [
    ...
    { id: 'p_shawarma', text: 'שווארמה עוף (מנה בצלחת, מסעדה — כ-200 גרם בשר)', hide: ['vegan', 'vegetarian'] },
    { id: 'p_shawarma_home', text: 'שווארמה עוף ביתית (כ-200 גרם בשר)', hide: ['vegan', 'vegetarian'] },
    { id: 'p_beef_meatballs', text: 'קציצות בקר (150 גרם, כ-3 יחידות)', hide: ['vegan', 'vegetarian', 'no_gluten'] },
    { id: 'p_fish_meatballs', text: 'קציצות דגים (150 גרם, כ-3 יחידות)', hide: ['vegan', 'vegetarian', 'no_fish', 'no_gluten'] },
