...
ללא מבוא. ללא סיכום. ללא הסברים בסוגריים. רק התוכן עצמו — חם, ממוקד, שלה.`
    ...
    if (mode === 'logsReport') {
      ...
      const prompt = 'את אתי אטל — יועצת תזונה התנהגותית. כתבי משוב ל-' + name + '.\n' +
        ...
        '💧 הידרציה: 1.5 ליטר ביום נחשב תקין ומספק — אל תעירי או תבקרי על מי שמגיעה ל-1.5 ליטר ומעלה. 2 ליטר זה בונוס נחמד, לא חובה. הערה על מים רק אם מתחת ל-1.5 ליטר.\n' +
        ...
        '**🎯 לשיפור**\nנקודה אחת על התנהגות או תזמון — לא חזרה על נתון שכבר הוזכר.\n\n'
        '**🚀 3 צעדים**\nספציפיים עם מספרים.\n\n' +
        '**💚 מסר**\nמשפט אחד מעצים.'
      const msg = await client.messages.create({
        model: 'claude-sonnet-4-6',
