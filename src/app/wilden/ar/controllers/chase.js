...
const COPY = {
  run: {
    ...
    NEAR: { line: 'הוא נעצר. הוא עייף.', sub: 'לחצו עליו כדי לתפוס!' },
  },
  fly: {
  ...
  shadow: {
    ...
    NEAR: { line: 'הצל נעצר לרגליכם.', sub: 'לחצו עליו, והוא יקום!' },
  },
  stomp: {
    FAR: { line: 'התקרבו אליו. הוא כבד, אבל מהיר.', sub: 'רוצו אליו!' },
    FLEE: { line: 'הוא רקע ונעלם!', sub: 'מאחוריכם! הסתובבו!' },
    NEAR: { line: 'הוא נשאר. הקווים דולקים.', sub: 'לחצו עליו כדי לתפוס!' },
  },
}
