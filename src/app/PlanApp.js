...
const FOOD_DB = [
  ...
  { id:'fd_burger',       name:'פטי המבורגר (150 גרם)',     cal:300, prot:26,   fat:20,   carbs:2,   base:1,   unit:'יח\'', dflt:1,   cat:'beef' },
  { id:'fd_burger_full',  name:'המבורגר מלא (בן + פטי)',   cal:550, prot:30,   fat:22,   carbs:40,  base:1,   unit:'יח\'', dflt:1,   cat:'beef' },
  ...
  { id:'fd_pizza_slice',  name:'פרוסת פיצה מרגריטה',       cal:250, prot:10,   fat:9,    carbs:34,  base:1,   unit:'פרוסה', dflt:2,  cat:'israeli' },
  { id:'fd_pizza_sl_ch',  name:'פרוסת פיצה גבינות',        cal:295, prot:13,   fat:13,   carbs:32,  base:1,   unit:'פרוסה', dflt:2,  cat:'israeli' },
  { id:'fd_pizza_sl_bu',  name:'פרוסת פיצה בולונז',        cal:290, prot:14,   fat:11,   carbs:34,  base:1,   unit:'פרוסה', dflt:2,  cat:'israeli' },
  // סושי
  { id:'fd_maki_veg',     name:'מאקי ירקות',               cal:35,  prot:1,    fat:0.3,  carbs:7,   base:1,   unit:'יח\'', dflt:8,   cat:'israeli' },
  { id:'fd_maki_salmon',  name:'מאקי סלמון',               cal:45,  prot:2.5,  fat:1.5,  carbs:6,   base:1,   unit:'יח\'', dflt:8,   cat:'israeli' },
  { id:'fd_maki_tuna',    name:'מאקי טונה',                cal:40,  prot:3,    fat:0.8,  carbs:6,   base:1,   unit:'יח\'', dflt:8,   cat:'israeli' },
  { id:'fd_cali_roll',    name:'קליפורניה מאקי',           cal:42,  prot:2,    fat:1.2,  carbs:6.5, base:1,   unit:'יח\'', dflt:8,   cat:'israeli' },
  { id:'fd_philly_maki',  name:'פילדלפיה מאקי',            cal:58,  prot:2.5,  fat:2.8,  carbs:6,   base:1,   unit:'יח\'', dflt:8,   cat:'israeli' },
  { id:'fd_spicy_tuna',   name:'ספייסי טונה מאקי',         cal:50,  prot:3,    fat:1.8,  carbs:6,   base:1,   unit:'יח\'', dflt:8,   cat:'israeli' },
  { id:'fd_nigiri_sal',   name:'ניגירי סלמון',             cal:60,  prot:5,    fat:2,    carbs:7,   base:1,   unit:'יח\'', dflt:6,   cat:'israeli' },
  { id:'fd_nigiri_tuna',  name:'ניגירי טונה',              cal:50,  prot:5,    fat:0.8,  carbs:7,   base:1,   unit:'יח\'', dflt:6,   cat:'israeli' },
  { id:'fd_temaki',       name:'טמאקי סלמון',              cal:180, prot:10,   fat:5,    carbs:24,  base:1,   unit:'יח\'', dflt:1,   cat:'israeli' },
            ...
            {rootsOpen ? (
              <div style={{ marginBottom: 24 }}>
                ...
                {[
                  ...
                  { key: 'roots_sentence', q: 'איזה משפט על אוכל או על הגוף שמעת בבית ועדיין מלווה אותך?', hint: 'משפט שאמרו הרבה בבית או שנחרט בזיכרון.' },
                  { key: 'roots_trigger', q: 'מתי את מרגישה שהאוכל הופך ליותר מרעב?', hint: 'בערב? בסטרס? בשעמום? אחרי ריב? כשאת לבד?' },
                  { key: 'roots_comfort', q: 'מה את מקבלת מהאוכל ברגעים האלה?', hint: 'נחמה? שקט? הפסקה? פיצוי? תחושת שליטה?' },
                  { key: 'roots_generation', q: 'איזה הרגל סביב אוכל עובר אצלך מדור לדור?', hint: 'הרגל שקיבלת מהבית ואת מזהה גם אצלך היום.' },
                  { key: 'roots_change', q: 'אם היית יכולה לשנות רק דבר אחד ביחסים שלך עם אוכל – מה הוא היה?', hint: 'בלי לחשוב על משקל. רק על התחושה.' },
                  { key: 'roots_fear', q: 'מה מפחיד אותך בתהליך הזה?', hint: 'מה הכי מדאיג אותך כשאת חושבת על שינוי?' },
                  { key: 'roots_hope', q: 'מה את מקווה שיקרה בחיים שלך כשהאוכל יפסיק לנהל אותך?', hint: 'מה יתפנה? איך תרגישי? מה יהיה אחרת?' },
