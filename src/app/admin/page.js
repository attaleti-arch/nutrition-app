...
export default function AdminPage() {
  ...
  function downloadDoctorPDF() {
    ...
    script.onload = function() {
      ...
      html2pdf().set({
        margin: 10,
        filename: 'מכתב-לרופא-' + fullName.trim() + '.pdf',
          ...
          <>
            ...
            {tab === 'doctor' && (
              <div>
                ...
                <button onClick={downloadDoctorPDF} style={{ width: '100%', padding: 14, borderRadius: 12, background: '#2563eb', color: '#fff', border: 'none', cursor: 'pointer', fontWeight: 700, fontSize: 16, marginBottom: 8 }}>
                  ⬇️ הורידי PDF
                </button>
