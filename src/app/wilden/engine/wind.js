...
//   1. גוסטבו מתחזק. כל פעם שהוא קופץ באותו טיול הוא מהיר יותר: עוד
...
// ── השם ──
// "גוסטבו. ה-ghost." רוח רפאים עם שם של דוד — וזה בדיוק העניין: מרגע
// שיש שם יש דמות ולא מכשול, וילד בן שש לא מפחד ממישהו שקוראים לו
// גוסטבו. (כתבתי כאן זמן־מה גובטבו, וזו הייתה טעות שלי.) הוא
// יושב כאן פעם אחת ונכנס לכל משפט דרך {wind} — כך ששינוי שם הוא שורה
// אחת, והגרמנית לא נשברת.
export const WIND_NAME = 'גוסטבו'
...
// ── מי שנחטף, ונשאר חטוף ──
// שלוש התוצאות של מפגש עם גוסטבו, ושלושתן שונות:
