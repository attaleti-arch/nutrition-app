...
// v3: מסלול שנשמר לפני שכבת הבטיחות אין בו סוג דרך ואין בו צמתים — ולכן
// "אל תעמידי אותה בצומת" לא יכול לרוץ עליו. הוא נזרק ונבנה מחדש.
// ("הלכתי אינסוף במדרכות ואז על כביש בצומת היא הייתה.")
const KEY = 'wilden_routes_v3'
