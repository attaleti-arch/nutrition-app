...
קצר. ממוקד. בשפתה שלה. ללא מבוא וללא סיכום.`
    ...
    if (mode === 'logsReport') {
      ...
      const prompt = 'אתה אתי אטל — יועצת תזונה התנהגותית. כתבי משוב ל-' + name + ' בעברית תקנית.\n' +
        ...
        'יעדי מאקרו: חלבון 40%, שומן 30%, פחמימות 30%.\n' +
        'אם יש חריגה במאקרו — ציין: "צרכת X% שומן במקום 30% המומלץ — כדאי להפחית."\n' +
        (nlpSummary ? 'מצב רוח: ' + nlpSummary + '\n' : '') +
        'נתונים:\n' + String(logsSummary).substring(0, 1500) + '\n\n' +
        '# ' + reportTitle + '\n\n' +
        '**✨ מה עבד**\nהצלחה אחת ספציפית עם מספרים.\n\n' +
        '**📊 מאקרו — בפועל מול יעד**\nלכל מאקרו שחרג — ציין אחוז בפועל מול יעד + המלצה קצרה.\n\n' +
