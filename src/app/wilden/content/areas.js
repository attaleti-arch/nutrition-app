...
export const AREAS = [
  ...
  // ── החצר ──
  // התפאורה השנייה שלה, ואותו עולם בדיוק: שער קשת, מזרקה יבשה, עמוד
  // שנפל, ורצפת אבן פתוחה שיש עליה איפה לעמוד. פתוחה מהרגע הראשון —
  // הצפיפות היא בעיה של היום, לא של פרק 3.
  { id: 'court', name: 'החצר', bg: '/world/court.jpg' },
  // והמקום הבא — מה שמאחורי השער — יושב כאן ברגע שהתפאורה שלו תגיע:
